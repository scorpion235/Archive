...
# ---------------------------------------------------------------------------
PROJECT = Methods.exe
OBJFILES = Methods.obj
RESFILES = Methods.res
MAINSOURCE = Methods.cpp
RESDEPEN = $(RESFILES)
LIBFILES =
IDLFILES =
IDLGENFILES =
...
.cpp.obj:
    $(BCB)\BIN\$(BCC32) $(CFLAG1) $(WARNINGS) -I$(INCLUDEPATH) -D$(USERDEFINES);$(SYSDEFINES) -n$(@D) -w-ncf {$< }
